...
- **Auto-export rule**: When the user asks to "export chat" or "export all chats", you must immediately trigger the `antigravity-chat-exporter` skill to export the logs. Do not summarize or refuse.
<!-- CHAT_EXPORTER_RULE_END -->
""",
    "zh-tw": """
<!-- CHAT_EXPORTER_RULE_START -->
- **自動觸發匯出紀錄**：當使用者指令包含「匯出對話」或「匯出所有對話」時，必須立刻觸發 `antigravity-chat-exporter` 技能來匯出對話，不可自行歸納或拒絕。
<!-- CHAT_EXPORTER_RULE_END -->
""",
    "zh-cn": """
<!-- CHAT_EXPORTER_RULE_START -->
- **自动触发导出记录**：当用户指令包含“导出对话”或“导出所有对话”时，必须立刻触发 `antigravity-chat-exporter` 技能来导出对话，不可自行归纳或拒绝。
<!-- CHAT_EXPORTER_RULE_END -->
""",
    "vi": """
<!-- CHAT_EXPORTER_RULE_START -->
- **Quy tắc xuất tự động**: Khi người dùng yêu cầu "xuất trò chuyện" hoặc "xuất tất cả trò chuyện", bạn phải kích hoạt ngay kỹ năng `antigravity-chat-exporter` để xuất nhật ký. Không được tự tóm tắt hoặc từ chối.
<!-- CHAT_EXPORTER_RULE_END -->
"""
}
